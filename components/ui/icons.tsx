...
/* ---------------------------------------------------------------------------
 * Icons below share one base. ALWAYS use an SVG icon for UI chrome —
 * never a Unicode symbol (▶ ✓ ★ 📅 …): iOS renders many of those as
 * colored emoji, which is exactly the "sidebar icons look broken on iPhone"
 * bug. Emoji are only for user content (reactions, the emoji picker).
 * ------------------------------------------------------------------------- */
...
export function HomeIcon(p: IconProps) {
  return (
    <Svg {...p}>
      ...
      <path d="M5.5 9v10.5a1 1 0 0 0 1 1h3.75v-6h3.5v6h3.75a1 1 0 0 0 1-1V9" />
    </Svg>
  );
}
...
export function UsersIcon(p: IconProps) {
  return (
    <Svg {...p}>
      ...
      <path d="M3 19.5c.6-3 3-4.75 6-4.75s5.4 1.75 6 4.75" />
      <path d="M16 5.5a3 3 0 0 1 0 6M17.5 14.9c1.9.55 3.2 2.1 3.5 4.6" />
    </Svg>
  );
}
...
export function PaperclipIcon(p: IconProps) {
  return (
    <Svg {...p}>
      <path d="m20.5 11.5-8.3 8.3a5 5 0 0 1-7.1-7.1l8.3-8.3a3.3 3.3 0 1 1 4.7 4.7l-8.3 8.3a1.7 1.7 0 0 1-2.4-2.4l7.6-7.6" />
    </Svg>
  );
}
...
export function SmileIcon(p: IconProps) {
  return (
    <Svg {...p}>
      ...
      <path d="M8.5 14.25a4.25 4.25 0 0 0 7 0M9 9.75h.01M15 9.75h.01" />
    </Svg>
  );
}
...
export function GifIcon(p: IconProps) {
  return (
    <Svg {...p}>
      <rect x="2.75" y="5" width="18.5" height="14" rx="3" />
      <path d="M10 10h-2.25a1.25 1.25 0 0 0-1.25 1.25v1.5A1.25 1.25 0 0 0 7.75 14H10v-2H8.75M12.75 10v4M15.5 14v-4h2.5M15.5 12h2" />
    </Svg>
  );
}
